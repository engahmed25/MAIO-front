...
export default function BookingSlots({ id }) {
  ...
  function handleBooking() {
    ...
    if (selectedDateIndex !== null && selectedTime) {
      ...
      submitBooking(selectedDate.fullDate, selectedTime.startTime, selectedTime.endTime);
    }
  }

  async function submitBooking(date, startTime, endTime) {
    setIsSubmitting(true);
    try {
      const response = await createReservation(id, date, startTime, endTime);
